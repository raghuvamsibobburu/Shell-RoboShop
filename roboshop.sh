...
SG_ID="sg-0abe24d1b55914caa" # replace with your SG ID
INSTANCES=("mongodb" "redis" "mysql" "rabbitmq" "catalogue" "user" "cart" "shipping" "payment" "dispatch" "frontend")
ZONE_ID="Z0630864SNPS171VLZQ6" # replace with your ZONE ID
DOMAIN_NAME="buyarobot.site" # replace with your domain
